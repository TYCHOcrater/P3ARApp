...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func setupScene() {
        ...
        leftWall.eulerAngles = SCNVector3.init(0, 180.0.degreeToRadians, 0)
